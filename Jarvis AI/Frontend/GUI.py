...
def SetMicrophoneStatus(Command):
    with open(rf'{TempDirPath}\Mic.data', "w", encoding='utf-8') as file:  # removed extra space after rf'
        file.write(Command)

def GetMicrophoneStatus():
    with open(rf'{TempDirPath}\Mic.data', "r", encoding='utf-8') as file:  # removed extra space
        Status = file.read()
    return Status

def SetAssistantStatus(Status):
    with open(rf'{TempDirPath}\Status.data', "w", encoding='utf-8') as file:  # removed extra space
        file.write(Status)

def GetAssistantStatus():
    with open(rf'{TempDirPath}\Status.data', "r", encoding='utf-8') as file:  # removed extra space
        Status = file.read()
    return Status
...
def ShowTextToScreen(Text):
    with open(rf'{TempDirPath}\Responses.data', "w", encoding='utf-8') as file:  # removed extra space
        file.write(Text)

class ChatSection(QWidget):
    def __init__(self):  # fixed constructor __init__
        ...
        layout.addWidget(self.label)  # fixed 'addwidget' -> 'addWidget'
        font = QFont()
